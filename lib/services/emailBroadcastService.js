 ...
 * and convert them to CID attachments
...
const sendEmailBroadcast = async ({
  ...
  try {
    ...
    const { html: processedMessage, attachments: inlineImages } =
      processInlineImages(broadcast.message);
    ...
    const emailContent = {
      ...
      html: generateBroadcastEmailHTML({
        ...
        message: processedMessage, // Use processed HTML with CIDs
      ...
      attachments: [
        ...
        ...inlineImages, // Add inline images as attachments
      ],
    };
...
const sendTestEmail = async ({
  ...
  const emailContent = {
    ...
    html: generateBroadcastEmailHTML({
      subject,
      message: processedMessage, // Use processed HTML
      announcementType,
      priority,
      isHtml: true,
    }),
    attachments: [
      ...
      ...inlineImages, // Add inline images
    ],
  };
