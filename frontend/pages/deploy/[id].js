...
import { ArrowLeft, CheckCircle, Loader, AlertCircle, Play, Square, RotateCw, Trash2 } from "lucide-react";
              ...
              <div className="space-y-4 mt-8">
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    disabled={actionLoading || deployment?.status === "active" || deployment?.status === "connected"}
                  ...
                  <button
                    ...
                    disabled={actionLoading || deployment?.status === "stopped" || deployment?.status === "offline"}
