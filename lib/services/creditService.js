  ...
  for (const bot of activeBots) {
    try {
      ...
      if (user.credits >= burnAmount) {
        ...
        // If current renewal is reasonable (within 24h of now), increment it exactly.
        // Otherwise reset to 24h from now to prevent weird backlog loops.
        if (currentNextRenewal > now.getTime() - oneDayMs) {
