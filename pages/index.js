...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden flex flex-col justify-center items-center text-center px-6 pt-32 pb-12 min-h-screen bg-gray-50 dark:bg-[#0f172a]">
